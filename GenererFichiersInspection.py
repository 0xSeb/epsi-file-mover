...
def copy_report_card(config, promo, year):
    ...
    report_card_dir = ""
    if promo == "I2":
        report_card_dir = os.path.join(config['dossier_parent'], 'BULLETINS', school_year, "I5 EPSI", "Definitifs")
        if not os.path.isdir(report_card_dir):
            report_card_dir_not_found = report_card_dir
            report_card_dir = os.path.join(config['dossier_parent'], 'BULLETINS', school_year, "I2 EPSI", "Definitifs")
            if not os.path.isdir(report_card_dir):
        ...
        report_card_dir = os.path.join(config['dossier_parent'], 'BULLETINS', school_year, "I4 EPSI", "Definitifs")
        if not os.path.isdir(report_card_dir):
            report_card_dir_not_found = report_card_dir
            report_card_dir = os.path.join(config['dossier_parent'], 'BULLETINS', school_year, "I1 EPSI", "Definitifs")
            if not os.path.isdir(report_card_dir):
        ...
        report_card_dir = os.path.join(config['dossier_parent'], 'BULLETINS', school_year, promo + " EPSI",
                                       "Definitifs")
        if not os.path.isdir(report_card_dir):
